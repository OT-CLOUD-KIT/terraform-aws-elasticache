...
variable "redis_engine_version" {
  ...
  validation {
    condition     = contains(["7.0", "7.1", "7.x", "6.x", "5.0.6", "4.0.10", "3.2.10", "3.2.6", "3.2.4", "2.8.24", "2.8.23", "2.8.22", "2.8.22", "2.8.19", "2.8.6", "2.6.13"], var.redis_engine_version)
...
variable "redis_family" {
  ...
  validation {
    condition     = contains(["redis7.x", "redis7", "redis6.x", "redis5.0", "redis4.0", "redis3.2", "redis2.8", "redis2.6"], var.redis_family)
